(function () {
    ...
    link.href = "https://vocaliq-client.onrender.com/assistant.css"
       ...
       <div class="vocaliq-top">
        ...
        <div class="vocaliq-bottom">
            ...
            <button class="vocaliq-mic">
               ...
               <img 
               src="https://vocaliq-client.onrender.com/mic.svg"
               alt="mic"
    ...
    button.innerHTML = `
    <img 
    src="https://vocaliq-client.onrender.com/logo.png"
    alt="logo"
    />`;
    ...
    const loadAssistant = async () => {
        try {
            const res = await fetch(`https://vocaliq-server.onrender.com/api/assistant/config/${userId}`)
      ...
      recognition.onresult = (e)=>{
        ...
        setTimeout( async () => {
            try {
                ...
                const res = await fetch("https://vocaliq-server.onrender.com/api/assistant/ask" , {
                    method:"POST",
                    headers:{
                        "Content-Type":
                      "application/json",
