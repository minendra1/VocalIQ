...
const themes = {
  ...
  sunset: {
    bg: "bg-[#1e1b4b]",
    overlay:
      "bg-[radial-gradient(circle_at_top,rgba(244,63,94,0.18),transparent_45%)]",
    orb: "from-rose-400 via-orange-500 to-amber-500",
    ...
    micGlow: "shadow-[0_0_70px_rgba(244,63,94,0.45)]",
  },
};
      ...
      >
        ...
        <div className="absolute top-4 right-4 sm:top-5 sm:right-5 z-30 flex items-center gap-2">
          ...
          <button
            ...
            className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-gradient-to-r from-rose-400 to-orange-500 border transition-all cursor-pointer ${
              theme === "sunset"
